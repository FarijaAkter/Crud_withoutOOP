        ...
        <div class="row justify-content-center">
            <div class="col-md-7">
                ...
                <ul class="nav justify-content-center fs-2">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="index.php">List item</a>
                    </li>
                    <li class="nav-item">
                        ...
                        foreach($carts as $cart):
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-warning"><a href="restore.php?id=<?=$cart['id'];?>" onclick="return confirm('Are you sure you want to restore?')" class="text-dark">Restore</a></button>
                                </td>
                            </tr>
                        <?php
                        endforeach;
